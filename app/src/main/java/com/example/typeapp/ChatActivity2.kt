...
class ChatActivity2 : AppCompatActivity() {
    ...
    private lateinit var imagesnd: ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view = findViewById<ImageView?>(R.id.profileview)
        ...
        sendbtn.setOnClickListener {
            ...
            if (message.isNotEmpty()) {     //if message is not empty
                dbref.child("Chats").child(senderRoom!!).child("message").push()    //sender room
                    .setValue(msgobject)
                    .addOnSuccessListener {
                        dbref.child("Chats").child(receiverRoom!!).child("message")
                            .push()  //receiver room
                            .setValue(msgobject)
                    }
